...
namespace SauceDemo.Tests
{
    public class SauceDemo : BaseTest
    {
        ...
        public void LocatorsTest()
        {
            ...
            //XPath
            Assert.That(Driver.FindElement(By.XPath("//input[@placeholder='Password']")).Displayed);
            ...
            Assert.That(Driver.FindElement(By.CssSelector("br")).Displayed);
            ...
            Assert.That(Driver.FindElement(By.CssSelector("[type*='tex']")).Displayed);
